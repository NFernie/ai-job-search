...
> Development geologist with an MPhil in Geoscience and almost eight years at Santos, spanning onshore and offshore wellsite operations, geomechanics, and development geology on Cooper Basin oil and tight-gas assets. Builds geology-driven static models in Petrel (uncertainty analysis, seismic depth conversion, static-to-dynamic handoff), generates development opportunities, and has geosteered seven horizontal wells across shallow marine and fluvial reservoirs. Quantitative seismic interpretation is a gap to close in an integrated team, not a claimed skill.

**For geosteering / well-planning / operations-geology roles:**
> Operations-grounded geologist: wellsite (mudlogging, coring, wireline, onshore and offshore), a geomechanics year (MEMs, offset-well and frac reviews), then development geology. Has overseen 100+ onshore wells, planned factory-style tight-gas campaigns of 20+ wells including frac, and geosteered seven oil horizontals in four fields. Best when the question is where the well is relative to the reservoir architecture.

**For research / basin-analysis roles:**
> Earth scientist with a first-author Scientific Reports paper on shear-zone reactivation, plus Cooper-Eromanga and McArthur Basin papers on thermal history and hydrocarbon maturation. Now applies that basin-history training inside an operator, and looks for roles where thermal history, structure, and well data still inform development decisions.
